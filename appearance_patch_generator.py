...
ap = argparse.ArgumentParser (description="Appearance and Motion DeepNet")
...
if args["path"] is None:
    imageDir = input("Please enter the path to the dataset:")
...
if args["datadst"] is None:
    dataDest = input("Please enter the path where you want to store the processed or spliced images:")
    print (dataDest)
...
appDatasetAll = open(os.path.join(dataDest,"appearance.p") ,'wb')
appDataset15 = open(os.path.join(dataDest,"appearance15.p") ,'wb')
appDataset18 = open(os.path.join(dataDest,"appearance18.p") ,'wb')
appDataset20 = open(os.path.join(dataDest,"appearance20.p") ,'wb')
                ...
                if image is not None:
                    ...
                    for sz in winSz:
                        ...
                        for (x, y, window) in mylib.sliding_window (resized, stepSize=15, windowSize=(tz, tz)):
                            ...
                            # For more complexity we can use color image but it will add more data depend on the channels we will be able to estimate
